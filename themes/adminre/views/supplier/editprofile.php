        ...
        <div class="row">
                    ...
                    <?php if(Yii::app()->user->hasFlash('error')){?>
                        ...
                        <div class="col-md-8 border_style_div" id="basic_link">
                            ...
                            <div class="col-md-3" id="profilePhotoDiv">
                                ...
                                <?php echo $form->hiddenField($suppliers,'image',array('id'=>"profilePicUser")); ?>
                            </div>
                            ...
                            <div class="col-md-9">
                                <div class="col-6 pl0">
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->textField($users,'company_name',array('placeholder'=>"Company Name",'title'=>"Company Name",'data-parsley-minlength'=>"2",'data-parsley-pattern'=>"^[a-zA-Z0-9,.@&!#'_*+\- ]+$",'class'=>'form-control text-input defaultText minlength','length'=>"2",'tabindex'=>'1'));?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php echo $form->textField($suppliers,'skype_id',array('placeholder'=>"Skype",'title'=>"Skype",'data-parsley-minlength'=>"2",'class'=>'form-control text-input defaultText minlength','length'=>"2",'tabindex'=>'1'));?>
                                    ...
                                    <div class="form-group col-md-12 pa0 mt10">
                                        <div class="col-md-6 pl0">
                                            ...
                                            <?php echo $form->textField($suppliers,'foundation_year',array('placeholder'=>"Founded In",'title'=>"Founded In",'data-parsley-type'=>"number",'data-parsley-maxlength'=>"4",'data-parsley-minlength'=>"4",'class'=>'form-control text-input defaultText minlength','length'=>"2",'tabindex'=>'2'));?>
                                            <?php if($check==1 )echo $form->error($suppliers,'foundation_year'); ?>
                                        </div>
                                        <div class="col-md-6 pl0">
                                            <label for="name2">No. of Employees</label>
                                            <?php echo $form->textField($suppliers,'number_of_employee',array('placeholder'=>"No of Employees",'title'=>"No of Employees",'data-parsley-type'=>"number",'class'=>'form-control text-input defaultText minlength','length'=>"2",'tabindex'=>'3'));?>
                                    ...
                                    <div class="form-group col-md-12 pa0 mt10">
                                        <div class="col-md-6 pl0">
                                            ...
                                            <?php echo $form->textField($suppliers,'project_size',array('placeholder'=>"Project Size",'title'=>"Project Size",'data-parsley-type'=>"number",'class'=>'form-control text-input defaultText','length'=>"2",'tabindex'=>'4'));?>
                                            <?php if($check==1 )echo $form->error($suppliers,'project_size'); ?>
                                        </div>
                                        <div class="col-md-6 pl0">
                                            <label for="name2">Avg. Per Hour Rate</label>
                                            <?php echo $form->textField($suppliers,'per_hour_rate',array('placeholder'=>"Per Hour Rate (20-30)",'title'=>"Per hour Rate (20-30)",'class'=>'form-control text-input defaultText','length'=>"2",'tabindex'=>'5','data-parsley-pattern'=>'^[0-9]{1,3}-[0-9]{1,3}$'));?>
                                            <?php if($check==1 )echo $form->error($suppliers,'per_hour_rate'); ?>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12 pa0 mt10" id="location_container">
                                        <div class="hide" id="dummy_location">
                                         <div>
                                            <div class="location_info">
                                             ...
                                             <a href="<?php echo CController::createUrl('/supplier/deleteOffice',array('oid'=>'s','action'=>'delete')); ?>" class="location_delete" onclick="return deletetlocation(this)">Delete</a>
                                            </div>
                                         </div>
                                        </div>
                                     <?php $oCount=1;
                                     if(!empty($offices)){ 
                                        ...
                                        <div class="location_info">
                                            <div class="col-md-6 pl0">
                                                <label for="name2">Location</label>
                                                <input type="text" class="form-control text-input" value="<?php echo $office->city->name."(".$office->city->countries->name.")"; ?>" />
                                          ...
                                          <?php if($office->dep->id!=1){ ?>
                                          <a href="<?php echo CController::createUrl('/supplier/deleteOffice',array('oid'=>base64_encode($office->id),'action'=>'delete'));?>" class="location_delete" onclick="return deletetlocation(this)">Delete</a>
                                          <?php } ?>
                                      </div>
                                      <?php $oCount++;
                                       }//end foreach ?>
                                      ...
                                      <div class="location_info">
                                        ...
                                        <a href="javascript:void(0)" class="location_delete hide" onclick="return deletetlocation(this)">Delete</a>
                                        </div>
            ...
            <div class="col-md-8 border_style_div mt15">
                ...
                <div class="col-md-3" id="coverPhotoDiv">
                    ...
                    <?php echo $form->hiddenField($suppliers,'cover',array('id'=>"coverPicUser")); ?>
                </div>
                <div class="col-md-9">

                    <div class="form-group">
                        <label for="name1">Description</label>
                        <?php echo $form->textArea($suppliers,'about_company',array('placeholder'=>"Description",'title'=>"Description",'data-parsley-minlength'=>"2",'class'=>'form-control text-input defaultText alphanum minlength','length'=>"2",'tabindex'=>'6'));?>
            ...
            <div class="col-md-4" id="onweb_link"></div>
            <div class="col-md-8 border_style_div mt15" id="past_client">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(".location_info input:text").typeahead({ hint: false },{source:index.ttAdapter({ "hitsPerPage": 10 }),displayKey:'label'}).on('typeahead:selected', function($e,datum){
            $(this).closest(".location_info").find('.cityid').val(datum.id);
            autoSave();
            //$(this).closest(".location_info").find('.location_delete').val(datum.id);
        });
        ...
        if(data){
         $.each( data, function( index, value ){
            if(value.id!="" && value.cityid != ""){
                ...
                var anchor = $("input[name='location["+index+"][id]']").closest('.location_info').find('.location_delete').attr('href');
                if(typeof anchor !='undefined'){
                   console.log(typeof anchor);
                   console.log(index);
                    anchor = anchor.replace('oid=s','oid='+value.e_id);
                    console.log(anchor);
                    $("input[name='location["+index+"][id]']").closest(".location_info").find('.location_delete').attr('href',anchor);                
                }  
            }
             });
...
function locationaddNew() {
    ...
    $dummy = $(d);
    $dummy.find(".id").attr("name", "location[" + locationcount + "][id]").val();
    $dummy.find(".cityid").attr("name", "location[" + locationcount + "][cityid]").val('');
    ...
    $("#location_container").append($dummy.html());
