...
<div class="grey">
	...
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
			We just noticed that you rejected a proposal. We would love to know why you rejected this proposal. Feel free to reply to this email with your thoughts or <a href="<?php echo Yii::app()->createAbsoluteUrl('site/call');?>">Schedule a call</a>.
			<br />
		</td>	
	</tr>
