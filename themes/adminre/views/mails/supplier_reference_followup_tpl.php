...
<div class="grey">
	...
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
			...
			<br/><br/>
			We, at VenturePact, believe customer feedback is crucial as it helps service providers improve and allows clients to make better decisions. We were wondering if you can take a minute to review & rate your experience with <?php echo $data["first_name"]." ".$data["last_name"] ?> from <?php echo $data["company_name"]; ?> for our platform.
			<br/><br/>
