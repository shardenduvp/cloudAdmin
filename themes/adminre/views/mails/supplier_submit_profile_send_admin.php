...
<div class="grey">
	...
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
			<?php echo $data['first_name']; ?> <?php echo $data['last_name']; ?> from <?php echo $data['company_name']; ?>  has submitted  profile, please review it in admin section
	...
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
        	All the best!<br />
			VenturePact Development Team<br />
