...
<div class="grey">
	...
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
			Welcome to VenturePact! We are here to help you find the right clients for your preferences. Please click on the link below to verify your email address.
		</td>
	</tr>
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
