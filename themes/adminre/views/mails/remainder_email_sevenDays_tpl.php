...
<div class="grey">
	...
	<tr style="background-color:#fff;">
		<td  style="padding:10px">
		Sam here from VenturePact. I just wanted to checkin to see how VenturePact is working out for you.
		<br /><br />
		If you have any questions about the product, or any feedback, just reply to this email or <a href="<?php echo Yii::app()->createAbsoluteUrl('site/login');?>">[schedule a call]</a>. We're always here to help.
