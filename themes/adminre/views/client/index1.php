<div class="navbar navbar-fixed-top bg-light top-head np">
	<ol class="breadcrumb p20">
		<li class="crumb-active">
			<a href="dashboard.html" class="fs24">Edit Profile</a>
		</li>				
	</ol>
	<ul class="nav navbar-nav navbar-right">
		<li>
			<p class="fs11 mt22"><span class="light_grey">Last saved</span>&nbsp; 5mins ago</p>
		</li>
		<li>
			<button class="btn small-btn btn-orange pa5 mt15 fs13 font_bold" type="button">Save</button>
		</li>
		<li class="ml10">
			<a href="" class="btn small-btn btn-default1 pa5 mt15 fs12 highlight">Preview</a>
		</li>
	</ul>
</div>
<div class="col-md-12 mb15 light_bg np">				
			<div class="row">
