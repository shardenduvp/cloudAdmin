...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'social_site'); ?>
		<?php echo $form->textField($model,'social_site',array('size'=>50,'maxlength'=>50)); ?>
		<?php echo $form->error($model,'social_site'); ?>
	</div>
