...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'reminder_date'); ?>
		<?php echo $form->textField($model,'reminder_date'); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'milestone_title'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'is_schedule_payment'); ?>
	...
	<div class="row">
		<?php echo $form->label($model,'supplier_proposal_id'); ?>
