...
<?php $form=$this->beginWidget('CActiveForm', array(
	'id'=>'suppliers-project-team-form',
	...
	<div class="row">
		<?php echo $form->labelEx($model,'project_proposal_id'); ?>
		<?php echo $form->textField($model,'project_proposal_id'); ?>
		<?php echo $form->error($model,'project_proposal_id'); ?>
	</div>
