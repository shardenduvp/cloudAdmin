...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'designation',array('size'=>60,'maxlength'=>250)); ?>
		<?php echo $form->error($model,'designation'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'dep'); ?>
		<?php echo $form->textField($model,'dep',array('size'=>60,'maxlength'=>250)); ?>
		<?php echo $form->error($model,'dep'); ?>
	</div>
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'linkedin',array('size'=>60,'maxlength'=>500)); ?>
