...
$('.search-form form').submit(function(){
	$('#suppliers-portfolio-has-industries-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Suppliers Portfolio Has Industries</h1>
...
<div class="row">
	<div class="col-md-12">
		...
		<div class="box border blue">
			...
			<div class="box-title">
				<h4><i class="fa fa-table"></i>List of suppliersPortfolioHasIndustries</h4>
			</div>
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	//'id'=>'suppliers-portfolio-has-industries-grid',
	'id'=>'datatables1',
