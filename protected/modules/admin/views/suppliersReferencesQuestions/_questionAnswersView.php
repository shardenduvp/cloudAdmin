...
<div class="textfont col-md-10">
	<?php
		foreach ($model as $answer) 
		{
			echo "<b>".$answer->reviewQuestions->title."</b>"."<br />";?>
	<?php 
			echo CHtml::textfield('answer['.$answer->id.'][answer]',$answer->answers,array('class'=>'form-control'))."<br>";  
...
<div class="col-md-1 rating-testimonial center col-md-offset-5">
		<?php 
			if($refcount!=0)
			{
