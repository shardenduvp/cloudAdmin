...
/**
 * This is the model class for table "client_profiles_has_cities".
 *
 * The followings are the available columns in table 'client_profiles_has_cities':
 * @property integer $id
...
class ClientProfilesHasCities extends CActiveRecord
{
	...
	{
		return 'client_profiles_has_cities';
	}
	...
	public function rules()
	{
		...
		return array(
			array('client_profiles_id, cities_id', 'required'),
			array('client_profiles_id, cities_id, is_main, status', 'numerical', 'integerOnly'=>true),
			array('add_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, client_profiles_id, cities_id, is_main, add_date, status', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ClientProfilesHasCities the static model class
	 */
