...
class Features extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('name, estimated_time', 'length', 'max'=>45),
			array('description', 'length', 'max'=>255),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, name, description, estimated_time, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'projectsFeaturesAndEstimations' => array(self::HAS_MANY, 'ProjectsFeaturesAndEstimations', 'features_id'),
		);
	}
