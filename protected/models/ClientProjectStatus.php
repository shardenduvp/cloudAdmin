...
/**
 * This is the model class for table "client_project_status".
 *
 * The followings are the available columns in table 'client_project_status':
 * @property integer $id
 ...
 */
class ClientProjectStatus extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('name, desc, add_date, status', 'length', 'max'=>45),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, client_portfolio_id, name, desc, add_date, status', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ClientProjectStatus the static model class
	 */
