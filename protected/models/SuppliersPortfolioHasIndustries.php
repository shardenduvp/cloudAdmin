...
/**
 * This is the model class for table "suppliers_portfolio_has_industries".
 *
 * The followings are the available columns in table 'suppliers_portfolio_has_industries':
 * @property integer $id
...
class SuppliersPortfolioHasIndustries extends CActiveRecord
{
	...
	{
		return 'suppliers_portfolio_has_industries';
	}
	...
	public function rules()
	{
		...
		return array(
			array('suppliers_has_portfolio_id, industries_id', 'required'),
			array('suppliers_has_portfolio_id, industries_id, status', 'numerical', 'integerOnly'=>true),
			array('add_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, suppliers_has_portfolio_id, industries_id, add_date, status', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return SuppliersPortfolioHasIndustries the static model class
	 */
