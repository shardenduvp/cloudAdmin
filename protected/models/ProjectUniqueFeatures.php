...
/**
 * This is the model class for table "project_unique_features".
 *
 * The followings are the available columns in table 'project_unique_features':
 * @property integer $id
 ...
 */
class ProjectUniqueFeatures extends CActiveRecord
{
	/**
	...
	{
		return 'project_unique_features';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, client_projects_id, name, description', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ProjectUniqueFeatures the static model class
	 */
